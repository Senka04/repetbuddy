...
urlpatterns = [
    ...
    path('course_preview/<str:pk>/', views.course_preview, name='course_preview'),
    path('home_video/stream/<str:pk>/', views.get_streaming_video, name='stream'),
    path('home_video/stream_for_course/<str:pk>/', views.get_streaming_video_for_course, name='stream_for_course'),
